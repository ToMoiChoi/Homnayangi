...
export const copy = {
  vi: {
    tiers: ['Món quen thuộc', 'Món ngon lành', 'Món thịnh soạn', 'Món tự thưởng', '★ Món đặc biệt'],
    title: 'Hôm nay ăn gì nhỉ? 🍽️', counterPrefix: 'Đã quay', counterSuffix: 'lần',
    counterTitle: 'Lượt gợi ý món ăn ghi nhận trên trình duyệt này', caseLabel: 'Vòng quay ẩm thực',
    soundOn: 'Bật âm', soundOff: 'Tắt âm', turnSoundOff: 'Tắt âm thanh', turnSoundOn: 'Bật âm thanh',
    github: 'GitHub', starsPending: 'chưa tải', language: 'Switch to English',
    spend: 'Ngân sách bữa ăn', custom: 'Tuỳ chỉnh', customSpend: 'Mức chi tuỳ chỉnh (nghìn đồng)',
    thousandPerMeal: 'nghìn / bữa', spendError: 'Nhập từ 30 đến 180 nghìn.', vegetarianPool: 'Thực đơn chay: trung bình',
    vegetarianOnly: 'Chỉ ăn chay', vegetarian: 'Món chay 🌿', opening: 'ĐANG CHỌN MÓN…', openAgain: 'CHỌN LẠI NÈ ✨', open: 'HÔM NAY ĂN GÌ? 🍽️',
    newItem: 'GỢI Ý DÀNH CHO BẠN 🌟', referencePrice: 'Giá tham khảo', perPerson: '/ người', find: 'Tìm quán gần đây 📍', continue: 'Đóng lại', nearby: 'gần đây',
    whatsInside: 'THỰC ĐƠN HÔM NAY', items: 'Gợi ý món ngon', mystery: '★ MÓN BÍ MẬT', mysteryAlt: 'Món bí mật siêu đặc biệt',
    footer: 'Trưa Nay Ăn Gì · SFX:', lunchDish: 'Món ăn trưa', vegetarianDish: 'Đồ chay',
  },
  en: {
    tiers: ['Classic', 'Popular', 'Delicious', 'Deluxe', '★ Special Chef Choice'],
    title: 'What should I eat today? 🍽️', counterPrefix: 'Spun', counterSuffix: 'times',
    counterTitle: 'Spins recorded on this browser', caseLabel: 'Food roulette',
    soundOn: 'Sound on', soundOff: 'Sound off', turnSoundOff: 'Mute sound', turnSoundOn: 'Enable sound',
    github: 'GitHub', starsPending: 'not loaded', language: 'Chuyển sang tiếng Việt',
    spend: 'Meal budget', custom: 'Custom', customSpend: 'Custom budget (k VND)',
    thousandPerMeal: 'k VND / meal', spendError: 'Enter 30–180k VND.', vegetarianPool: 'Current pool average',
    vegetarianOnly: 'Vegetarian only', vegetarian: 'Vegetarian 🌿', opening: 'PICKING FOOD…', openAgain: 'SPIN AGAIN ✨', open: 'WHAT TO EAT? 🍽️',
    newItem: 'TODAY’S RECOMMENDATION 🌟', referencePrice: 'Estimated price', perPerson: '/ person', find: 'Find nearby 📍', continue: 'Done', nearby: 'near me',
    whatsInside: "TODAY'S MENU", items: 'Dishes in menu', mystery: '★ MYSTERY DISH', mysteryAlt: 'Mystery dish',
    footer: 'What to eat · SFX:', lunchDish: 'Lunch dish', vegetarianDish: 'Vegetarian',
  },
} as const;
...
const englishNames: Record<number, string> = {
  ...
  132:'Samyang spicy noodles',133:'Spicy ramen soup',134:'Dry spicy ramen',135:'Cheese Samyang ramen',136:'Carbonara Samyang ramen',137:'2X Spicy Samyang ramen',138:'Mixed glass noodles',
};
